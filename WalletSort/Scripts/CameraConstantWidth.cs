...
public class CameraConstantWidth : MonoBehaviour
{
    ...
    [SerializeField] Vector3 _positionStep = new Vector3();
    ...
    private void Start()
    {
        ...
        float fov =  CalcVerticalFov(horizontalFov, componentCamera.aspect);
        componentCamera.fieldOfView = fov;

        float dist = initialFov - fov;
        transform.Translate(dist*_positionStep,Space.World);
    }
